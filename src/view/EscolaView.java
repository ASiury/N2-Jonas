                    ...
                    try{
                        if (o == 1) {
                            ...
                            do {
                                ...
                                codigo = ler.nextLine();
                                System.out.println(control.cadastrarTurma(ano, turma, sala, codigo, turno));
                            } while(!Objects.equals(codigo, "0"));
                        }
                        else if (o == 2) {
                            System.out.println("Informe o codigo da turma:");
                            ...
                            String disciplina = ler.nextLine();
                            System.out.println(control.vincularDisciplinaTurma(turma, disciplina));
                        }  else if (o == 8) {
                            System.out.println("Informe o codigo da turma:");
                            String turma = ler.nextLine();
                            System.out.println("Informe o código da disciplina a ser removida:");
                            String disciplina = ler.nextLine();
                            System.out.println(control.desvincularDisciplinaTurma(turma, disciplina));
                        } else if (o == 9) {
